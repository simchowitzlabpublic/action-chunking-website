...
<FigureEnv>
  <HStack>
    <Figure src="/figs/halfcheetah_chunk_sweep.png" alt="Action chunking sweep results" />
    <Figure src="/figs/halfcheetah_prop_sweep.png" alt="Proportional sweep results" />
    <Figure src="/figs/halfcheetah_sweep.png" alt="HalfCheetah sweep results" />
    <Figure src="/figs/humanoid_sweep.png" alt="Humanoid sweep results"/>
  </HStack>
</FigureEnv>
...
<FigureEnv>
  <HStack>
    <Figure src="/figs/noise_inj_sweep_noisy.png" alt="Noise injection sweep: noisy trajectories"/>
    <Figure src="/figs/noise_inj_sweep_sigma.png" alt="Noise injection sweep: sigma parameter"/>
    <Figure src="/figs/noise_inj_sweep_alpha_sigma1.png" alt="Noise injection sweep: alpha and sigma1"/>
  </HStack>
</FigureEnv>
