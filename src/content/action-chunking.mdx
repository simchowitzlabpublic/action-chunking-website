...
<FigureEnv>
    <Figure src="/figs/action_chunking.svg" alt="Visualization of the stabilizing effect of action chunks"/>
</FigureEnv>
...
<FigureEnv>
  <HStack>
    <Figure src="/figs/robomimic_toolhang.png" alt="RoboMimic experiments: Success rates as a function of evaluated action-chunk lengths"/>
    <Figure src="/figs/robomimic_traj100.svg" alt="RoboMimic trajectory results"/>
    <Figure src="/figs/robomimic_clean_vs_noise.svg" alt="RoboMimic clean vs noise comparison"/>
  </HStack>
</FigureEnv>